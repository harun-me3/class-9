...
class SubTopicHindi extends StatefulWidget {
  final index1;
  final index2;
  final index3;
  final index4;
  ...
  const SubTopicHindi(this.subtopicDataSet, this.index1, this.index2,
      this.index3, this.index4, this.topicName);

  @override
  _SubTopicHindiState createState() => _SubTopicHindiState();
}

class _SubTopicHindiState extends State<SubTopicHindi> {
 Future<DataSet> loaddataset() async {
    String jsonstring =
        await rootBundle.loadString('assets/data_image/HindiModal.json');
                ...
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Lottie.asset(
                        'assets/header/topicwithoutsubtopicenglish.json'),
                          ...
                          : Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                           DownloadPlatformSubtopic(index, snapshot.data, widget.index1,widget.index2,widget.index3,widget.index4,'hi')),
                                ).then((value){
