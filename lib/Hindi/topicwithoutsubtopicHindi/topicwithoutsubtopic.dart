...
class TopicWithoutSubTopicHindi extends StatefulWidget {
  final List<TopicDataSet> topicDataSet;
  final index1;
  final index2;
  final index3;
  final String booksolutionname;
  TopicWithoutSubTopicHindi(this.topicDataSet, this.index1, this.index2,
      this.index3, this.booksolutionname);

  @override
  _TopicWithoutSubTopicHindiState createState() =>
      _TopicWithoutSubTopicHindiState();
}

class _TopicWithoutSubTopicHindiState extends State<TopicWithoutSubTopicHindi> {
